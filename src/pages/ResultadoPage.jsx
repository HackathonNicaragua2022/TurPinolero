      ...
      <div className="flex flex-row mt-10 justify-center">
        ...
        <Card sx={{ maxWidth: 345 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              Baje una tirolesa a través de un bosque nuboso durante este
              recorrido de 5 horas desde Managua. Visite el Volcán Mombacho de
              4,410 pies (1,344 metros)
            </Typography>
          </CardContent>
          <CardActions>
        ...
        <Card sx={{ maxWidth: 345 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              Rodeada por dos cerros de mediana elevación, la Bahía de San Juan del Sur alberga la ciudad playera más visitada por surfistas. Su casco urbano ofrece una completa y variada oferta turística,
            </Typography>
          </CardContent>
          <CardActions>
            <Button variant="outlined" color="primary" size="small">
        ...
        <Card sx={{ maxWidth: 345 }}>
          ...
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              Cabañas Lobolira es un residencial íntimo de 8 diferentes cabañas rústicas y apartamentos a solo 5 minutos a pie de la zona de restaurantes del centro de San Juan.
            </Typography>
          </CardContent>
          <CardActions>
            <Button variant="outlined" color="primary" size="small">
